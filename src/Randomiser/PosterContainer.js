    ...
    <div className="justify-center items-center flex  md:h-[450px] md:w-[300px]">
      ...
      >
        {props.resultHistory.length == 0 ? (
          <div className="text-center text-lg font-mono text-white p-4 mt-[8rem] bg-[#1F2937] rounded-lg hidden md:block">
        ...
        {!props.resultHistory.length == 0 ? (
          <img
            className="object-cover rounded-lg h-[337.5px] w-[225px] md:h-[450px] md:w-[300px] "
            src={
